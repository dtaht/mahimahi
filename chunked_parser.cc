...
string::size_type ChunkedBodyParser::read( const std::string & input_buffer,  __attribute__( ( unused ) ) Archive & archive, __attribute__( ( unused ) ) ByteStreamQueue & from_dest )
{
